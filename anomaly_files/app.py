...
def load_all_models():
    ...
    lstm_model = load_model('LSTM/lstm_autoencoder_anomaly_detection.h5')
    lstm_scaler = joblib.load('LSTM/standard_scaler.save')

    # CNN Fault Detection models
    cnn_model = load_model('CNN/cnn_fault_detection.keras')
    cnn_encoder = joblib.load('CNN/label_encoder_cnn.joblib')

    # ANN Fault Detection models
    ann_model = load_model('ANN/fault_detection_model.h5')
    ann_encoder = joblib.load('ANN/label_encoder_aan.joblib')
